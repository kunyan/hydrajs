...
if (process && process.env && process.env.HYDRA_HOSTNAME) {
    ...
    } else if (window.location.hostname === 'access.devgssici.devlab.phx1.redhat.com' || window.location.hostname === 'ci.foo.redhat.com' || window.location.hostname === 'fooci.redhat.com') {
        hydraHostName = new Uri('http://fuseadmin-corp-dev-redhat-com.vserver.devlab.ext.phx1.redhat.com/hydra/rest/');
